...
export class User implements iEntity {
	...
	constructor(base?: any){
		if (base !== undefined){
			...
			this.usr_date_last_login_attempt = base.usr_date_last_login_attempt;
			this.usr_date_pwd_change = base.usr_date_pwd_change;
			...
			this.usr_date_add = base.usr_date_add;
			this.usr_date_mod = base.usr_date_mod;
