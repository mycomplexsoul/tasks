...
export class Preset implements iEntity {
	...
	public pre_id_category: string;
	public pre_id_place: string;
	public pre_desc: string;
	public pre_notes: string;
	public pre_id_user: string;
	public pre_date_add: Date;
	public pre_date_mod: Date;
	...
	constructor(base?: any){
		if (base !== undefined){
			...
			this.pre_date = new Date(base.pre_date);
			...
			this.pre_date_add = new Date(base.pre_date_add);
			this.pre_date_mod = new Date(base.pre_date_mod);
