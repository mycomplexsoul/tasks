...
export class Task implements iEntity {
	...
	constructor(base?: any){
		if (base !== undefined){
			...
			this.tsk_date_done = new Date(base.tsk_date_done);
			...
			this.tsk_schedule_date_start = new Date(base.tsk_schedule_date_start);
			this.tsk_schedule_date_end = new Date(base.tsk_schedule_date_end);
			this.tsk_date_view_until = new Date(base.tsk_date_view_until);
			...
			this.tsk_date_due = new Date(base.tsk_date_due);
			...
			this.tsk_rep_date_end = new Date(base.tsk_rep_date_end);
			...
			this.tsk_date_add = new Date(base.tsk_date_add);
			this.tsk_date_mod = new Date(base.tsk_date_mod);
