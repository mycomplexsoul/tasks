...
export class Task implements iEntity {
	...
	constructor(base?: any){
		if (base !== undefined){
			...
			this.tsk_date_done = base.tsk_date_done;
			...
			this.tsk_schedule_date_start = base.tsk_schedule_date_start;
			this.tsk_schedule_date_end = base.tsk_schedule_date_end;
			this.tsk_date_view_until = base.tsk_date_view_until;
			...
			this.tsk_date_due = base.tsk_date_due;
			...
			this.tsk_rep_date_end = base.tsk_rep_date_end;
			...
			this.tsk_date_add = base.tsk_date_add;
			this.tsk_date_mod = base.tsk_date_mod;
